...
print(N100)
#Plot N100 prices
plot(N100$Close ~N100$Date,type="l",col="darkblue",axes="T",xlab="Date",ylab="Closing Prices", 
...
# Chart of Training vs Test

plot(N1001$`N1001$Close`~N1001$`N1001$Date`,type='l', col='darkblue',
     main='Dataset Comparison', xlab='Date',ylab='Closing Price', pch=1)
lines(N1002$Close~N1002$Date,col='Darkorange',lwd=2, type='p',pch=5)
legend('topleft',
       legend = c('Training Dataset','Test Dataset'),
       col=c('Darkblue','Darkorange'),
       pch=c(type='l',2))
