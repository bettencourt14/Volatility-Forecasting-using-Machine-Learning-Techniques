...
# write_xlsx(N100_Table,
#           "E:\\Thesis Francisco Bettencourt\\Tese Nov\\4. Data\\R models\\Error By Country\\N100\\N100_error.xlsx"
 #          ,col_names = T,
  #         format_headers = T,use_zip64 = FALSE)
...
nop1<-DM.test(N100_training_DM$GARCH,N100_training_DM$MIDAS,N100_training_DM$actual)
nop2<-DM.test(N100_training_DM$GARCH,N100_training_DM$SVR,N100_training_DM$actual)
nop3<-DM.test(N100_training_DM$GARCH,N100_training_DM$LSTM,N100_training_DM$actual)
nop4<-DM.test(N100_training_DM$MIDAS,N100_training_DM$SVR,N100_training_DM$actual)
nop5<-DM.test(N100_training_DM$MIDAS,N100_training_DM$LSTM,N100_training_DM$actual)
nop6<-DM.test(N100_training_DM$SVR,N100_training_DM$LSTM,N100_training_DM$actual)
...
# write_xlsx(nop_table,
           # "E:\\Thesis Francisco Bettencourt\\Tese Nov\\4. Data\\R models\\Error By Country\\N100\\N100_DM_training.xlsx"
           # ,col_names = T,format_headers = T,use_zip64 = FALSE)
...
N100_SVR_test<-as.numeric(N100_SVR_forecast$N100_SVR_forecast)
...
test1<-DM.test(N100_test_DM$GARCH,N100_test_DM$M.Carlo,N100_test_DM$actual)
test2<-DM.test(N100_test_DM$GARCH,N100_test_DM$MIDAS,N100_test_DM$actual)
test3<-DM.test(N100_test_DM$GARCH,N100_test_DM$SVR,N100_test_DM$actual)
test4<-DM.test(N100_test_DM$GARCH,N100_test_DM$LSTM,N100_test_DM$actual)
test5<-DM.test(N100_test_DM$M.Carlo,N100_test_DM$MIDAS,N100_test_DM$actual)
test6<-DM.test(N100_test_DM$M.Carlo,N100_test_DM$SVR,N100_test_DM$actual)
test7<-DM.test(N100_test_DM$M.Carlo,N100_test_DM$LSTM,N100_test_DM$actual)
test8<-DM.test(N100_test_DM$MIDAS,N100_test_DM$SVR,N100_test_DM$actual)
test9<-DM.test(N100_test_DM$MIDAS,N100_test_DM$LSTM,N100_test_DM$actual)
test10<-DM.test(N100_test_DM$SVR,N100_test_DM$LSTM,N100_test_DM$actual)
...
#write_xlsx(test_table,
 #          "E:\\Thesis Francisco Bettencourt\\Tese Nov\\4. Data\\R models\\Error By Country\\N100\\N100_DM_test.xlsx"
  #         ,col_names = T,format_headers = T,use_zip64 = FALSE)
