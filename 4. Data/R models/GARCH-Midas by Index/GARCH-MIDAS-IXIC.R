...
plot(abs(as.numeric(IXIC1_return[IXIC1_lower:IXIC1_total,1]))*100
     ...
     main='NASDAQ GARCH-MIDAS Conditonal SD vs. Actual Returns',
     col='grey')
...
plot(abs(IXIC2_returns[,])~IXIC2$Date,type='l',col='black',
     xlab='Date',ylab='Return', main='NASDAQ Absolute returns vs. GARCH-MIDAS Forecast',
     ylim=c(0,0.07))
lines(IXIC_GARCH_MIDAS_forecast_SD$e~IXIC2$Date,type='l',col='Orange')
