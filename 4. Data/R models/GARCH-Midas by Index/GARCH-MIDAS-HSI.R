...
plot(abs(as.numeric(HSI1_return[HSI1_lower:HSI1_total,1]))*100
     ...
     main='Hang Seng GARCH-MIDAS Conditonal SD vs. Actual Returns',
     col='grey')
...
plot(abs(HSI2_returns[,])~HSI2$Date,type='l',col='black',
     xlab='Date',ylab='Return', main='Hang Seng Absolute returns vs. GARCH-MIDAS Forecast',
     ylim=c(0,0.07))
lines(HSI_GARCH_MIDAS_forecast_SD$e~HSI2$Date,type='l',col='Orange')
