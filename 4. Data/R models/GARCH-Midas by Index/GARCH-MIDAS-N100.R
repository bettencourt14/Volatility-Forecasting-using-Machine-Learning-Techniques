...
plot(abs(as.numeric(N1001_return[N1001_lower:N1001_total,1]))*100
     ...
     main='Euronext 100 GARCH-MIDAS Conditonal SD vs. Actual Returns',
     col='grey')
...
plot(abs(N1002_returns[,])~N1002$Date,type='l',col='black',
     xlab='Date',ylab='Return', main='Euronext 100 Absolute returns vs. GARCH-MIDAS Forecast',
     ylim=c(0,0.07))
lines(N100_GARCH_MIDAS_forecast_SD$e~N1002$Date,type='l',col='Orange')
